        ...
        <div class="row" style="height: 120px;">
            ...
            <nav class="col-2 py-2 d-flex justify-content-space-around align-items-center">
                ...
                <div class="dropdown-menu">
                    <%@include file="/WEB-INF/components/announcement-list.jsp" %>
                </div>

                <a id="nav_notification" class="nav_icon" data-bs-toggle="dropdown" data-bs-target="#notification-list">
                    <img src="assets/img/notification_icon.png" alt="notification icon" />
                </a>
                <div class="dropdown-menu">
                    <%@include file="/WEB-INF/components/notification-list.jsp" %>
                </div>
