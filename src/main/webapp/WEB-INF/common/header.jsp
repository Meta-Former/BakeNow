...
<header>
    ...
    <div style="width:1440px; margin:0 auto;">
        <div class="row">
            ...
            <div class="col-6 py-2 d-flex justify-content-center align-items-center">
                <form class="mb-0" action="MainController">
                    <input type="text" class="py-1" name="search" placeholder="Enter a recipe ..."
                           style="border: 1px solid #bfa3a3; border-radius:5px; width:550px; padding-left:10px;">
                    <input type="submit" class="py-1" name="action" value="Search" 
                           style="border: 1px solid #bfa3a3; border-radius:5px;" >
                </form>
            </div>
            ...
            <div class="col-2 d-flex justify-content-left align-items-center">
                <div class="py-1 px-2 d-flex" style="border: 1px solid #bfa3a3; border-radius: 5px; background-color: #f5f5f5;">
    ...
    <div style="width:100%; background-color:#F5F5F5">
        <div class="row align-items-center" style="width:100%; height:120px; margin:0 auto; background-image: url('assets/img/subheader.jpg'); background-size:cover;">
            <div class="row_subheader d-flex" style="justify-content:space-around">
                ...
                <button type="button" class="btn btn-outline-dark col-6 nav-recipe" onclick="window.location.href = '${blogHomeLink}';"
                        style="width:15%; margin-left:30%; background-color:#C5C5C5; font-weight:bold">RECIPES</button>
                ...
                <button type="button" class="btn btn-outline-dark col-6 nav-marketplace"  onclick="window.location.href = '${marketplaceLink}';" 
                        style="width:15%; margin-right:30%; background-color:#C5C5C5; font-weight:bold">MARKETPLACE</button>
            </div>
        </div>
    </div>
</header>
