                ...
                <div class="create_recipe col-10">
                    ...
                    <div class="d-flex justify-content-center my-3 py-3" style="background-color: #fff;">
                        <form action="" class="create_recipe_form col-10">
                            <div class="py-2" > 
                                <span style="font-size: 24px; font-weight: bold;">Title</span> <input type="text" style="width: 500px; padding-left: 10px;" name="title" required="" value="${param.RECIPE.title}">
                            </div>
                            <div class="py-2" > 
                                <span style="font-size: 24px; font-weight: bold;">Time to make</span> <input type="number" style="width: 75px; padding-left: 10px;" name="cookTime" required="" value="${param.RECIPE.timeToCook}">
                            </div>
                            <div class="py-2 d-flex justify-content-center">
                                <div class="col-4 py-2">
                                    <image src="${param.RECIPE.imgUrl}assets/img/blank_img.png" style="height: 256px; width: 256px; display: block; margin: 0 auto; border-radius: 5px;">
                            ...
                            <c:forEach var="m" begin="1" end="${param.RECIPE.stepCount}3">
                                <div class="recipe_create_form_step">
                                    ...
                                    <textarea class="my-2 py-2" type="text" style=" padding-left: 10px; width: 100%; height: 150px;" name="title" required=""></textarea>
                                </div>
                            </c:forEach>
