...
<html>
    ...
    <body>
        ...
        <div id="page_home" class="main-container container">
            ...
            <div class="page_title">
                ...
                <div class="button-1" >
                    ...
                    <a href="${pageScope.ToCreateRecipe}"><p>Create a recipe</p></a>
                </div>
            </div>  
                    ...
                    <div class="recipe">
                        ...
                        <div class="recipe_body">
                            <a href="${pageScope.ToViewRecipe}"><h5 class="recipe_title">Banh Cupcake Nho Kho</h5><a>
                                    <p class="recipe_author">By: <a href="#">Peter Parking</a></p><br>
